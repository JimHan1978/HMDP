package com.hyetec.hmdp.core.http.imageloader.glide;
 ...
 */
@GlideModule(glideName = "GlideArch")
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        BaseImageLoaderStrategy imageLoaderStrategy = ArchUtils.INSTANCE.obtainArchComponent(context).imageLoader().getStrategy();
